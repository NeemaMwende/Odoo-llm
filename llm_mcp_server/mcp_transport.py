...
class MCPTransport:
    ...
    def build_json_rpc_response(self, request_id: Optional[any], result: dict = None, error: dict = None):
    ...
    def json_rpc_http_response(self, request_id: Optional[any], result: dict = None, error: dict = None):
    ...
    def handle_post_request(self):
        ...
        try:
            ...
            return self.http_error_response(None, INTERNAL_ERROR, f"Internal error: {str(e)}")
    ...
    def handle_delete_request(self):
        ...
        if self.session_manager.is_stateless_mode():
            return self.http_error_response(None, METHOD_NOT_FOUND, "DELETE not supported in stateless mode")
    ...
    def handle_session_delete(self):
        ...
        try:
            ...
            return self.http_error_response(None, INTERNAL_ERROR, f"Failed to delete session: {str(e)}")
    ...
    def yield_sse_event(self, event_type: str, message: JSONRPCResponse, session_id: str):
    ...
    def replay_events(self, session_id: str, last_event_id: str):
        ...
        try:
            ...
            return self.http_error_response(None, INTERNAL_ERROR, f"Failed to resume stream: {str(e)}")