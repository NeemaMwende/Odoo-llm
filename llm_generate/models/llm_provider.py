...
class LLMProvider(models.Model):
    ...
    def generate_media(self, inputs, model_record=None, stream=False):
        ...
        """
        return self._dispatch("generate_media", inputs, model_record=model_record, stream=stream)
    ...
    def format_generation_response(self, raw_response, output_schema):
        ...
        """
        return self._dispatch("format_generation_response", raw_response, output_schema=output_schema)
